...
joined_dataset1 %>% group_by(Tm) %>% summarize(Count=n()) #%>% #gt() #%>%
  #tab_header(title= "Player Counts for Each Team")
...
ggplot(joined_dataset1, aes(x=Age, y=GS)) + geom_bar(stat="summary") +
  xlab("Age") + ylab("Games Started") + 
  ggtitle("Games Started by the Age of Player")
